package ie.setu.bin_there_app.ui.home
...
import ie.setu.bin_there_app.databinding.HomeBinding
import ie.setu.bin_there_app.databinding.NavHeaderBinding
import ie.setu.bin_there_app.ui.auth.LoggedInViewModel
import ie.setu.bin_there_app.ui.auth.Login
...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
                R.id.addPoiFragment, R.id.poiListFragment, R.id.aboutFragment), drawerLayout)
